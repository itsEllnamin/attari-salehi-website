...
class CustomUserManager(BaseUserManager):
    def create_user(self, mobile_number, password, activation_code=None, email='', name='', family=''):
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    mobile_number = models.CharField(_('شماره موبایل'), max_length=11, unique=True)
    ...
    activation_code = models.CharField(_('کد فعالسازی'), max_length=100, null=True, blank=True)
...
class Customer(models.Model):
    user = models.OneToOneField(CustomUser, models.CASCADE, primary_key=True, related_name='customer', verbose_name=_("کاربر"))
